...
import { ArrowRight, Download, Github, Linkedin, Mail, Code, Server, Cloud, Database } from "lucide-react"
...
export default async function HomePage() {
  const [featuredProjects, settings, featuredPosts] = await Promise.all([
    getFeaturedProjects(),
    getSettings(),
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl lg:text-2xl text-muted-foreground">DevOps-focused Full-Stack Developer</p>
                <p className="text-lg text-muted-foreground max-w-2xl">{settings.siteDescription}</p>
              </div>
              ...
              <div className="flex space-x-6">
                <Link href={settings.githubUrl} className="text-muted-foreground hover:text-primary transition-colors">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Here are some of my recent projects that showcase my skills in full-stack development and DevOps.
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Ready to work together?</h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            I'm currently available for DevOps roles and freelance projects. Let's build something amazing together.
          </p>
